...
from router_cli.client import RouterClient
from router_cli.models import (
    ADSLStats,
    DHCPLease,
    InterfaceStats,
    LogEntry,
...
class TestStatusParsing:
    ...
    @pytest.fixture
    def status(self, device_info_html: str) -> RouterStatus:
        """Parse status from fixture HTML."""
        return parse_status(device_info_html)
...
class TestStatusDataclass:
    ...
    def test_wan_connections_mutable_default(self):
        ...
        status1.wan_connections.append(WANConnection(interface="test"))
...
class TestWirelessClientsParsing:
    ...
    def test_parse_wireless_clients(self, wlstationlist_html: str):
        """Test wireless clients parsing."""
        clients = parse_wireless_clients(wlstationlist_html)
        assert len(clients) == 4

    def test_wireless_client_fields(self, wlstationlist_html: str):
...
class TestDHCPLeasesParsing:
    ...
    def test_parse_dhcp_leases(self, dhcpinfo_html: str):
        """Test DHCP leases parsing."""
        leases = parse_dhcp_leases(dhcpinfo_html)
        assert len(leases) == 7

    def test_dhcp_lease_fields(self, dhcpinfo_html: str):
...
class TestRoutesParsing:
    ...
    def test_parse_routes(self, routeinfo_html: str):
        """Test routing table parsing."""
        routes = parse_routes(routeinfo_html)
        assert len(routes) == 4

    def test_route_fields(self, routeinfo_html: str):
    ...
    def test_default_route(self, routeinfo_html: str):
...
class TestStatisticsParsing:
    ...
    def test_parse_statistics(self, statistics_html: str):
        """Test statistics parsing."""
        stats = parse_statistics(statistics_html)
        assert stats is not None

    def test_lan_interfaces(self, statistics_html: str):
        """Test LAN interface stats parsing."""
        stats = parse_statistics(statistics_html)
        assert len(stats.lan_interfaces) == 5

    def test_lan_interface_values(self, statistics_html: str):
    ...
    def test_wan_interfaces(self, statistics_html: str):
        """Test WAN interface stats parsing."""
        stats = parse_statistics(statistics_html)
        assert len(stats.wan_interfaces) == 3

    def test_adsl_stats(self, statistics_html: str):
...
class TestLogsParsing:
    ...
    def test_parse_empty_logs(self, logview_html: str):
        """Test empty logs parsing."""
        logs = parse_logs(logview_html)
        # The fixture has an empty log table
        assert len(logs) == 0

    def test_parse_logs_with_entries(self):
...
class TestEdgeCases:
    ...
    def test_parse_empty_wireless_clients(self):
        ...
        """
        clients = parse_wireless_clients(html)
        assert len(clients) == 0

    def test_parse_empty_dhcp_leases(self):
    ...
    def test_extract_value_no_match(self):
        """Test extract_value returns N/A when no match."""
        result = extract_value("<html>no match</html>", r"nonexistent: (\w+)")
        assert result == "N/A"

    def test_extract_value_multiple_patterns(self):
        """Test extract_value tries multiple patterns."""
    ...
    def test_route_non_numeric_metric(self):
...
class TestInfoHtmlParsing:
    ...
    @pytest.fixture
    def status(self, info_html: str) -> RouterStatus:
        """Parse status from info.html fixture."""
        return parse_status(info_html)
...
class TestWirelessClientsDetails:
    ...
    def test_all_wireless_clients(self, wlstationlist_html: str):
    ...
    def test_wireless_client_mac_formats(self):
...
class TestDHCPLeasesDetails:
    ...
    def test_all_dhcp_leases(self, dhcpinfo_html: str):
    ...
    def test_dhcp_lease_expiry_formats(self, dhcpinfo_html: str):
        """Test DHCP lease expiry times are parsed."""
        leases = parse_dhcp_leases(dhcpinfo_html)
        for lease in leases:
            assert "hours" in lease.expires_in or "minutes" in lease.expires_in

    def test_specific_lease_values(self, dhcpinfo_html: str):
...
class TestRoutesDetails:
    ...
    def test_all_routes(self, routeinfo_html: str):
        """Test all routes are parsed correctly."""
        routes = parse_routes(routeinfo_html)
        assert len(routes) == 4

    def test_route_flags(self, routeinfo_html: str):
    ...
    def test_local_network_route(self, routeinfo_html: str):
    ...
    def test_gateway_routes(self, routeinfo_html: str):
...
class TestStatisticsDetails:
    ...
    def test_all_lan_interfaces(self, statistics_html: str):
    ...
    def test_inactive_interfaces(self, statistics_html: str):
    ...
    def test_wireless_interface_stats(self, statistics_html: str):
    ...
    def test_wan_interface_stats(self, statistics_html: str):
    ...
    def test_adsl_snr_margin(self, statistics_html: str):
    ...
    def test_adsl_attenuation(self, statistics_html: str):
    ...
    def test_adsl_output_power(self, statistics_html: str):
    ...
    def test_adsl_attainable_rate(self, statistics_html: str):
    ...
    def test_adsl_traffic_type(self, statistics_html: str):
        """Test ADSL traffic type parsing."""
        stats = parse_statistics(statistics_html)
        assert stats.adsl.traffic_type == "ATM"

    def test_adsl_link_power_state(self, statistics_html: str):
